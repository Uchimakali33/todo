...
function Home(){
    return (
        <>
        <div className="bg-black/90 flex flex-col items-center pb-100">
            <div className="pt-5 col-span-2 mt-50">
                <h1 className="text-3xl font-semibold mb-5 text-white">Hello,<span className="font-bold text-emerald-400 font-sans">Welcome to My First App</span></h1>
